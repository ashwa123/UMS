                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-23efdf282dc962c59a47ce3aed2cd6c4"' : 'data-target="#xs-components-links-module-AppModule-23efdf282dc962c59a47ce3aed2cd6c4"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-23efdf282dc962c59a47ce3aed2cd6c4"' :
                                            'id="xs-components-links-module-AppModule-23efdf282dc962c59a47ce3aed2cd6c4"' }>
                                            <li class="link">
